                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                ...
                                <table>
                                    <tr>
                                        <td><input class="form-control" type="text" name="t1" placeholder="Enter book name" required></td>
                                        <td><input type="submit" name="submit1" value="Search books " class="form-control btn btn-default " style="margin-top:5px;"></td>
                                    </tr>
                                </table>

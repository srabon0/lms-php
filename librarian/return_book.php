                        ...
                        <div class="x_panel">
                            ...
                            <table class="table table-bordered">
                               <tr>
                                ...
                                {
                                    $res5=mysqli_query($conn," SELECT * FROM issue_books");
                                    echo "<table class='table table-bordered'>";
                                    echo "<tr>";
                                    echo "<th>" ; echo "Student enrollment";echo "</th>";                             echo "<th>" ; echo "Student name"; echo "</th>";
                                    ...
                                    echo "<tr>";
                                        ...
                                        echo "<td>"; echo $row['student_sem']; echo "</td>";                           echo "<td>"; echo $row['student_contact']; echo "</td>";
